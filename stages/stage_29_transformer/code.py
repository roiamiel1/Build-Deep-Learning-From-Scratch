...
class LayerNorm:
    ...
    def backward(self, grad_out: np.ndarray) -> np.ndarray:
        ...
        set gamma_grad/beta_grad. (stage_22's standardize backward over axis=-1.)"""
...
class TransformerBlock:
    """One Transformer block: residual MHA sublayer (stage_28) + residual
    position-wise FFN sublayer (stage_11, D->d_ff->D, ReLU). ``norm`` selects
