...
against the analytic gradient from ``Tensor.backward()`` (stage_09), applied to
...
if Stage9_Tensor is None:  # pragma: no cover
    pytest.skip("stage_09 Tensor not available", allow_module_level=True)
