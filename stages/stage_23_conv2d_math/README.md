...
multiply via **im2col**, so all the `stage_07` matmul-gradient machinery applies directly. No
...
4-D shape. This is the bridge to `stage_07`: convolution *is* matmul once you im2col.
...
**Done when**
- `pytest stage_23_conv2d_math/test.py` passes.
