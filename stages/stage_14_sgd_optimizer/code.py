...
# Tensor engine from stage_09 (optimizer only reads .grad / writes .data).
...
class Optimizer:
    ...
    def __init__(self, params: Iterable["Stage9_Tensor"]) -> None:
...
class SGD(Optimizer):
    ...
    def __init__(self, params: Iterable["Stage9_Tensor"], lr: float = 0.01) -> None:
